...
class OmdbModel {
  ...
  OmdbModel(this.title, this.year, this.rated, this.actors, this.poster,
      this.genre, this.director, this.metascore, this.country, this.language);

  factory OmdbModel.fromJson(Map<String, dynamic> json) =>
      _$OmbdModelFromJson(json);

  Map<String, dynamic> toJson() => _$OmbdModelToJson(this);
}
